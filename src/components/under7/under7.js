...
const Under7 = () => {
    ...
    useEffect(() => {
      ...
      try {
        let response = await fetch('https://www.cheapshark.com/api/1.0/deals?storeID=1&steamRating=85&upperPrice=7&pageSize=10&pageNumber=0');
        if (!response.ok) {
  ...
  return (
    <div className='containerbox'>
      <br></br>
      <h1 id='headerStyle'>Games under £7
      </h1>
